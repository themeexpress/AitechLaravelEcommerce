    ...
    <div class="wthree_banner_bottom_left_grid_sub1">
        <div class="col-md-4 wthree_banner_bottom_left">
            <div class="wthree_banner_bottom_left_grid">
                <img src="{{asset('public/front_end/images/4.jpg')}}" alt=" " class="img-responsive" />
        ...
        <div class="col-md-4 wthree_banner_bottom_left">
            <div class="wthree_banner_bottom_left_grid">
                <img src="{{asset('public/front_end/images/5.jpg')}}" alt=" " class="img-responsive" />
        ...
        <div class="col-md-4 wthree_banner_bottom_left">
            <div class="wthree_banner_bottom_left_grid">
                <img src="{{asset('public/front_end/images/6.jpg')}}" alt=" " class="img-responsive" />
                            ...
                            <figure>
                                <div class="snipcart-item block" >
                                    <div class="snipcart-thumb">
                                        ...
                                        <h4>BDT {{$v_all_published_product->product_price}}</h4>
                                    </div>
            ...
            <div class="col-md-9 w3l_fresh_vegetables_grid_right">
                <div class="col-md-4 w3l_fresh_vegetables_grid">
                    <div class="w3l_fresh_vegetables_grid1">
                        <img src="{{asset('public/front_end/images/8.jpg')}}" alt=" " class="img-responsive" />
                    </div>
                </div>
                <div class="col-md-4 w3l_fresh_vegetables_grid">
                    <div class="w3l_fresh_vegetables_grid1">
                        <div class="w3l_fresh_vegetables_grid1_rel">
                            <img src="{{asset('public/front_end/images/7.jpg')}}" alt=" " class="img-responsive" />
                    ...
                    <div class="w3l_fresh_vegetables_grid1_bottom">
                        <img src="{{asset('public/front_end/images/10.jpg')}}" alt=" " class="img-responsive" />
                ...
                <div class="col-md-4 w3l_fresh_vegetables_grid">
                    <div class="w3l_fresh_vegetables_grid1">
                        <img src="{{asset('public/front_end/images/9.jpg')}}" alt=" " class="img-responsive" />
                    </div>
                    <div class="w3l_fresh_vegetables_grid1_bottom">
                        <img src="{{asset('public/front_end/images/11.jpg')}}" alt=" " class="img-responsive" />
                    </div>
                </div>
                <div class="clearfix"> </div>
